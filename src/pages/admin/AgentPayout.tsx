  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-text-primary">Payout</h1>
          <p className="text-text-secondary text-sm mt-0.5">Execute payouts by transfer reference</p>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex-1 relative">
            ...
            <input
              ...
              placeholder="Enter transfer reference code (e.g. QSR-A3F2-...)"
                  ...
                  <tr key={t.id} className="border-b border-border last:border-0">
                    ...
                    <td className="py-2 text-right">
                      <div className="flex items-center gap-1.5 ml-auto justify-end">
                        ...
                        >
                          {busyId === t.id ? <Loader2 size={12} className="animate-spin" /> : <XCircle size={12} />}
                          Cancel
                        </button>
                      </div>
                    </td>
